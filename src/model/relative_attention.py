"""
Full copy of
https://github.com/openspeech-team/openspeech/blob/main/openspeech/modules/relative_multi_head_attention.py
https://github.com/openspeech-team/openspeech/blob/main/openspeech/modules/positional_encoding.py
https://github.com/openspeech-team/openspeech/blob/main/openspeech/modules/conformer_attention_module.py
"""
...
class RelativeMultiHeadAttention(nn.Module):
    ...
    def forward(
        ...
        if mask is not None:
            score = score + self._transform_mask(mask)
...
class ConformerMultiHeadedSelfAttentionModule(nn.Module):
    ...
    def __init__(
        ...
        super(ConformerMultiHeadedSelfAttentionModule, self).__init__()
